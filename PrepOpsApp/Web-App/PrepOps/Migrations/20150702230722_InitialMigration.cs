    ...
    public partial class InitialMigration : Migration
    {
        public override void Up(MigrationBuilder migration)
        {
            ...
            migration.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrepOpsTask", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrepOpsTask_Activity_ActivityId",
                        columns: x => x.ActivityId,
                        referencedTable: "Activity",
                        referencedColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PrepOpsTask_Tenant_TenantId",
                        columns: x => x.TenantId,
                        referencedTable: "Tenant",
                        referencedColumn: "Id");
                });
            migration.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskUsers_PrepOpsTask_TaskId",
                        columns: x => x.TaskId,
                        referencedTable: "PrepOpsTask",
                        referencedColumn: "Id");
                    table.ForeignKey(
        ...
        public override void Down(MigrationBuilder migration)
        {
            ...
            migration.DropTable("PrepOpsTask");
