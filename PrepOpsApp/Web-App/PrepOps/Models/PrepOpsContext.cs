...
{
    public class PrepOpsContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<PrepOpsTask> Tasks { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Activity>()
                .Collection<PrepOpsTask>(a => a.Tasks);
            ...
            modelBuilder.Entity<PrepOpsTask>()
