...
{
    public interface IPrepOpsDataAccess
    {
        ...
        #region PrepOpsTask CRUD
        IEnumerable<PrepOpsTask> Tasks { get; }

        PrepOpsTask GetTask(int taskId, string userId);

        PrepOpsTask GetTask(int taskId);

        Task AddTask(PrepOpsTask task);

        Task DeleteTask(int taskId);

        Task UpdateTask(PrepOpsTask value);
