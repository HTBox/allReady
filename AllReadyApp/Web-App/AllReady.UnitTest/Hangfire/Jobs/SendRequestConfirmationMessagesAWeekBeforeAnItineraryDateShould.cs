...
namespace AllReady.UnitTest.Hangfire.Jobs
{
    public class SendRequestConfirmationMessagesAWeekBeforeAnItineraryDateShould : InMemoryContextTest
    {
        ...
        [Fact]
        public void ScheduleIDayBeforeRequestConfirmationMessageSenderWithCorrectParameters_WhenRequestIdsMatchExistingRequests_AndThoseRequestsHaveAStatusOfPendingConfirmation_AndTodayIsLessThanSevenDaysBeforeTheItineraryDate()
        {
        ...
        public void NotSendRequestConfirmations_WhenRequestIdsMatchExistingRequests_AndThoseRequestsHaveAStatusOfPendingConfirmation_AndTodayIsLessThanSevenDaysBeforeTheItineraryDate()
        {
            ...
            var sut = new SendRequestConfirmationMessagesAWeekBeforeAnItineraryDate(Context, backgroundJobClient.Object, smsSender.Object)
            {
