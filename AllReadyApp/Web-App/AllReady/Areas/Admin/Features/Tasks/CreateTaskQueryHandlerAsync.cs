...
{
    public class CreateTaskQueryHandlerAsync : IAsyncRequestHandler<CreateTaskQueryAsync, EditViewModel>
    {
        private readonly AllReadyContext context;

        public CreateTaskQueryHandlerAsync(AllReadyContext context)
        {
            this.context = context;
        }

        public async Task<EditViewModel> Handle(CreateTaskQueryAsync message)
        {
