...
{
    public class EventSummaryQueryHandler : IAsyncRequestHandler<EventSummaryQuery, EventSummaryViewModel>
    {
        private readonly AllReadyContext _context;

        public EventSummaryQueryHandler(AllReadyContext context)
        {
            _context = context;
        }
