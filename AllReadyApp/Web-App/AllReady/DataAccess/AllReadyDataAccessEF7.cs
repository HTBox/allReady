...
namespace AllReady.Models
{
    public class AllReadyDataAccessEF7 : IAllReadyDataAccess
    {
        ...
        Task IAllReadyDataAccess.AddActivitySignup(ActivitySignup userSignup)
        {
            _dbContext.ActivitySignup.Add(userSignup);
            return _dbContext.SaveChangesAsync();
        }

        Task IAllReadyDataAccess.DeleteActivitySignup(int activitySignupId)
        {
        ...
        Task IAllReadyDataAccess.UpdateActivitySignup(ActivitySignup value)
        {
        ...
        Task IAllReadyDataAccess.AddTaskSignup(TaskUsers taskSignup)
        {
            _dbContext.TaskSignup.Add(taskSignup);
            return _dbContext.SaveChangesAsync();
        }

        Task IAllReadyDataAccess.DeleteTaskSignup(int taskSignupId)
        {
        ...
        Task IAllReadyDataAccess.UpdateTaskSignup(TaskUsers value)
        {
        ...
        Task IAllReadyDataAccess.AddTask(AllReadyTask task)
        {
            if (task.Id == 0)
            {
                _dbContext.Add(task);
        ...
        Task IAllReadyDataAccess.DeleteTask(int taskId)
        {
        ...
        Task IAllReadyDataAccess.UpdateTask(AllReadyTask value)
        {
