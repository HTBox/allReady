  ...
  public class SampleDataGenerator
  {
    ...
    public void InsertTestData()
    {
      ...
      Activity queenAnne = new Activity()
      {
        ...
        Tenant = htb,
        RequiredSkills = new List<Skill>() { surgeon, cprCertified }
      };
    ...
    public async Task CreateAdminUser()
    {
      ...
      if (user == null)
      {
        ...
        _userManager.AddClaimAsync(user, new Claim("UserType", "SiteAdmin")).Wait();
        ...
        user2.AssociatedTenant = _context.Tenants.First();
        _userManager.CreateAsync(user2, _configuration["DefaultAdminPassword"]).Wait();
        _userManager.AddClaimAsync(user2, new Claim("UserType", "TenantAdmin")).Wait();
