...
export module AllReady.Controls {
    export class Thermometer {
        ...
        constructor(container: JQuery) {
            ...
            svg.selectAll(".bar")
                ...
                .transition()
                .duration(1750)
                .attr("height", d => this.height * (d.currentValue / d.maxValue))
                .attr("y", d => this.height - (this.height * (d.currentValue / d.maxValue)));
            ...
            svg.selectAll(".value")
                ...
                .transition()
                .delay(1750)
                .text(d=> `${this.currentValue}/${this.maxValue}`);
