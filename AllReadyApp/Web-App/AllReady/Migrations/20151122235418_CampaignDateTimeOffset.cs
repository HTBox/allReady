...
{
    public partial class CampaignDateTimeOffset : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE Campaign SET StartDateTime = StartDateTimeUtc, EndDateTime = EndDateTimeUtc");
            migrationBuilder.DropColumn(name: "EndDateTimeUtc", table: "Campaign");
            migrationBuilder.DropColumn(name: "StartDateTimeUtc", table: "Campaign");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<DateTime>(
                ...
                nullable: false,
                defaultValue: new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified));
            migrationBuilder.Sql("UPDATE Campaign SET StartDateTimeUtc = StartDateTime, EndDateTimeUtc = EndDateTime");
            
            migrationBuilder.DropColumn(name: "EndDateTime", table: "Campaign");
            migrationBuilder.DropColumn(name: "StartDateTime", table: "Campaign");
            migrationBuilder.AddForeignKey(
                name: "FK_Activity_Campaign_CampaignId",
                table: "Activity",
                column: "CampaignId",
